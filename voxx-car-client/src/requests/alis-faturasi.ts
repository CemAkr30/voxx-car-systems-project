...
export const updateAlisFaturasi = async (alisFaturasi: AlisFaturasi): Promise<void> => {
    try {
        await axiosClient.put<AlisFaturasi>(`${urls.alisfaturasi}/${alisFaturasi.id}`, alisFaturasi);
