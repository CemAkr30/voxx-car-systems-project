...
export default function LoginPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const response = await fetch("http://localhost:8081/realms/voxx-car-systems/protocol/openid-connect/token", {
        method: "POST",
        headers: {
        ...
        <Card className="w-full h-full rounded-none border-0 shadow-none">
          <div className="flex flex-col justify-center h-full px-8 py-12">
            <CardHeader className="space-y-1 pb-6">
              ...
              <CardDescription className="text-center text-gray-600">Hesabınıza giriş yapmak için bilgilerinizi girin</CardDescription>
            </CardHeader>
            <CardContent className="space-y-6">
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                <div className="space-y-2">
                  ...
                  <Input id="username" type="text" placeholder="Kullanıcı adınızı girin" value={username} onChange={(e) => setUsername(e.target.value)} required disabled={isLoading} className="h-11 border-gray-300 focus:border-blue-500 focus:ring-blue-500" />
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <Input id="password" type="password" placeholder="Şifrenizi girin" value={password} onChange={(e) => setPassword(e.target.value)} required disabled={isLoading} className="h-11 border-gray-300 focus:border-blue-500 focus:ring-blue-500" />
                </div>
                ...
                <Button type="submit" className="w-full h-11 bg-blue-600 hover:bg-blue-700 text-white font-medium transition-colors" disabled={isLoading || !isCaptchaValid}>
                  {isLoading ? (
                    <>
        ...
        <div className="relative w-full h-full">
          ...
          <div className="absolute inset-0 flex flex-col justify-center items-center text-white p-12">
            <div className="text-center space-y-6 max-w-2xl">
              ...
              <p className="text-xl text-blue-100 leading-relaxed animate-fade-in-up-delay">Gelişmiş araç yönetim sistemi ile filonuzu kontrol altında tutun. Gerçek zamanlı takip, akıllı analiz ve güvenli yönetim.</p>
