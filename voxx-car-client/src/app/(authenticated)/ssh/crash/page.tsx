...
export default function KazaPage() {
  ...
  const [selectedOnarimDurumuFilter, setSelectedOnarimDurumuFilter] =
    useState<string>("all");
  ...
  useEffect(() => {
    const filtered = kazalar.filter((kaza) => {
      ...
      const aracMatch =
        selectedAracFilter === "all" || kaza.aracFiloId === selectedAracFilter;
      const firmaMatch =
        selectedFirmaFilter === "all" || kaza.firmaId === selectedFirmaFilter;
      const ilMatch =
        selectedIlFilter === "all" || kaza.kazaIli === selectedIlFilter;
      const onarimDurumuMatch =
        selectedOnarimDurumuFilter === "all" ||
        kaza.onarimDurumu === selectedOnarimDurumuFilter;
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      const selectedOdeyenFirma = firmalar.find(
        (f) => f.id === formData.odeyenFirmaId
      );
          ...
          prev.map((item) =>
            item.id === editingKaza.id
              ? {
                  ...
                  odeyenFirmaAdi:
                    selectedOdeyenFirma?.adi || item.odeyenFirmaAdi,
  ...
  const exportToExcel = () => {
    ...
    const csvContent =
      ...
      filteredKazalar
        .map(
          (item) =>
            `${item.id},${item.aracPlaka},${item.aracMarka} ${item.aracModel},${
              item.firmaAdi
            },${new Date(item.kazaTarihi).toLocaleDateString("tr-TR")},${
              item.kazaIli
            },${item.kazaNedeni},${item.kazaTutanagi},${item.onarimDurumu},${
              item.odeyenFirmaAdi
            }`
        )
        .join("\n");
    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-gray-600 mt-2">
          Araç kazalarını yönetin ve takip edin
        </p>
      </div>
        ...
        <CardContent>
          ...
          <div className="space-y-4 mb-6">
            ...
            <div className="flex items-center space-x-2 flex-wrap gap-2">
              <Select
                value={selectedOnarimDurumuFilter}
                onValueChange={setSelectedOnarimDurumuFilter}
              >
              ...
              <TableHeader>
                <TableRow>
                  <TableHead className="w-12">
                    <Checkbox
                      checked={
                        selectedItems.length === paginatedKazalar.length &&
                        paginatedKazalar.length > 0
                      }
                  ...
                  <TableRow key={kaza.id}>
                    <TableCell>
                      <Checkbox
                        ...
                        onCheckedChange={(checked) =>
                          handleSelectItem(kaza.id, checked as boolean)
                        }
                      />
                    </TableCell>
                    ...
                    <TableCell>
                      <DropdownMenu>
                        ...
                        <DropdownMenuContent>
                          <DropdownMenuItem
                            onClick={() => openDetailDialog(kaza)}
                          >
                            <Eye className="h-4 w-4 mr-2" />
                            Detay
                          </DropdownMenuItem>
                          <DropdownMenuItem
                            onClick={() => openEditDialog(kaza)}
                          >
                            <Edit className="h-4 w-4 mr-2" />
                            Düzenle
                          </DropdownMenuItem>
                          <DropdownMenuItem
                            onClick={() => openDeleteDialog(kaza)}
      ...
      <Dialog open={isFilterDialogOpen} onOpenChange={setIsFilterDialogOpen}>
        <DialogContent className="max-w-2xl">
          <DialogHeader>
            ...
            <DialogDescription>
              Kaza listesini filtrelemek için kriterleri seçin
            </DialogDescription>
          </DialogHeader>
          <div className="grid grid-cols-2 gap-4">
            <div>
              <Label>Araç</Label>
              <Select
                value={selectedAracFilter}
                onValueChange={setSelectedAracFilter}
              >
                <SelectTrigger>
            ...
            <div>
              <Label>Firma</Label>
              <Select
                value={selectedFirmaFilter}
                onValueChange={setSelectedFirmaFilter}
              >
                <SelectTrigger>
            ...
            <div>
              <Label>İl</Label>
              <Select
                value={selectedIlFilter}
                onValueChange={setSelectedIlFilter}
              >
                <SelectTrigger>
      ...
      <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
        <DialogContent className="max-w-2xl">
          <DialogHeader>
            <DialogTitle>
              {editingKaza ? "Kaza Kaydını Düzenle" : "Yeni Kaza Kaydı"}
            </DialogTitle>
            <DialogDescription>
              {editingKaza
                ? "Kaza bilgilerini güncelleyin"
                : "Yeni bir kaza kaydı ekleyin"}
            </DialogDescription>
          </DialogHeader>
          <div className="grid grid-cols-2 gap-4">
            <div>
              ...
              <Select
                ...
                onValueChange={(value) =>
                  setFormData({ ...formData, aracFiloId: value })
                }
              >
                <SelectTrigger>
                  <SelectValue placeholder="Araç seçin" />
            ...
            <div>
              ...
              <Select
                ...
                onValueChange={(value) =>
                  setFormData({ ...formData, firmaId: value })
                }
              >
                <SelectTrigger>
                  <SelectValue placeholder="Firma seçin" />
              ...
              <Popover>
                <PopoverTrigger asChild>
                  ...
                  >
                    <Calendar className="mr-2 h-4 w-4" />
                    {formData.kazaTarihi
                      ? format(new Date(formData.kazaTarihi), "PPP", {
                          locale: tr,
                        })
                      : "Tarih Seçin"}
                  </Button>
            ...
            <div>
              ...
              <Select
                value={formData.kazaIli}
                onValueChange={(value) =>
                  setFormData({ ...formData, kazaIli: value })
                }
              >
                <SelectTrigger>
                  <SelectValue placeholder="İl seçin" />
            ...
            <div>
              ...
              <Select
                ...
                onValueChange={(value) =>
                  setFormData({ ...formData, onarimDurumu: value })
                }
              >
                <SelectTrigger>
                  <SelectValue placeholder="Durum seçin" />
            ...
            <div>
              ...
              <Select
                ...
                onValueChange={(value) =>
                  setFormData({ ...formData, kazaTutanagi: value })
                }
              >
                <SelectTrigger>
            ...
            <div>
              ...
              <Select
                ...
                onValueChange={(value) =>
                  setFormData({ ...formData, odeyenFirmaId: value })
                }
              >
                <SelectTrigger>
            ...
            <div className="col-span-2">
              ...
              <Textarea
                ...
                onChange={(e) =>
                  setFormData({ ...formData, kazaNedeni: e.target.value })
                }
      ...
      <Dialog open={isDetailDialogOpen} onOpenChange={setIsDetailDialogOpen}>
        <DialogContent className="max-w-3xl max-h-[90vh] overflow-y-auto">
          <DialogHeader>
            ...
            <DialogDescription>
              {viewingKaza?.aracPlaka} - {viewingKaza?.aracMarka}{" "}
                  ...
                  <CardContent className="p-4">
                    ...
                    <div className="space-y-2 text-sm">
                      <div>
                        ...
                        {new Date(viewingKaza.kazaTarihi).toLocaleDateString(
                          "tr-TR",
                          {
                            day: "2-digit",
                            month: "2-digit",
                      ...
                      <div>
                        <span className="text-gray-600">Kaza İli:</span>{" "}
                        {viewingKaza.kazaIli}
                      </div>
                      <div>
                  ...
                  <CardContent className="p-4">
                    ...
                    <div className="space-y-2 text-sm">
                      ...
                      <div>
                        ...
                        {new Date(viewingKaza.createdAt).toLocaleDateString(
                          "tr-TR"
                        )}
                      </div>
                      <div>
                        <span className="text-gray-600">Son Güncelleme:</span>{" "}
                        {new Date(viewingKaza.updatedAt).toLocaleDateString(
                          "tr-TR"
                        )}
                      </div>
                    </div>
              ...
              <Card>
                <CardContent className="p-4">
                  ...
                  <p className="text-gray-700">
                    {viewingKaza.kazaNedeni || "Belirtilmemiş"}
                  </p>
                </CardContent>
              </Card>
      ...
      <Dialog open={isDeleteDialogOpen} onOpenChange={setIsDeleteDialogOpen}>
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              {deletingKaza?.aracPlaka} plakalı araca ait kaza kaydını silmek
      ...
      >
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              {selectedItems.length} kaza kaydını silmek istediğinizden emin
