...
export default function BrandPage() {
  ...
  const handleDelete = async () => {
    ...
    try {
      ...
      setMarkalar((prev) =>
        prev.filter((item) => item.id !== deletingMarka.id)
      );
    ...
    <div className="space-y-6">
      ...
      <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
        <DialogContent>
          <DialogHeader>
            <DialogTitle>
              {editingMarka ? "Marka Düzenle" : "Yeni Marka Ekle"}
            </DialogTitle>
            <DialogDescription>
              {editingMarka
      ...
      <Dialog open={isDeleteDialogOpen} onOpenChange={setIsDeleteDialogOpen}>
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              "{deletingMarka?.adi}" markasını silmek istediğinizden emin
      ...
      >
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              {selectedItems.length} markayı silmek istediğinizden emin misiniz?
