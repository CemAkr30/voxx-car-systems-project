...
export default function ModelPage() {
  ...
  const handleDelete = async () => {
    ...
    try {
      ...
      setModeller((prev) =>
        prev.filter((item) => item.id !== deletingModel.id)
      );
  ...
  const exportToExcel = () => {
    ...
    const csvContent =
      ...
      filteredModeller
        .map(
          (item) =>
            `${item.id},${item.adi},${item.markaAdi},${item.createdAt},${item.updatedAt}`
        )
        .join("\n");
              ...
              <TableHeader>
                <TableRow>
                  <TableHead className="w-12">
                    <Checkbox
                      checked={
                        selectedItems.length === filteredModeller.length &&
                    ...
                    <TableCell>
                      <Checkbox
                        ...
                        onCheckedChange={(checked) =>
                          handleSelectItem(model.id, checked as boolean)
                        }
                      />
                    </TableCell>
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <Select
                ...
                onValueChange={(value) =>
                  setFormData({ ...formData, markaId: value })
                }
              >
                <SelectTrigger>
                  <SelectValue placeholder="Marka seçin" />
      ...
      <Dialog open={isDeleteDialogOpen} onOpenChange={setIsDeleteDialogOpen}>
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              "{deletingModel?.adi}" modelini silmek istediğinizden emin
      ...
      >
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              {selectedItems.length} modeli silmek istediğinizden emin misiniz?
