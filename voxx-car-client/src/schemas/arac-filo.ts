...
export const aracFiloCreateSchema = z.object({
	...
	tramer: z.boolean({ required_error: "Tramer durumu bilgisi zorunludur." }),
	tramerTutari: z.coerce.number(),
	sonKmTarihi: z.date({ required_error: "Son kilometre tarihi zorunludur." }),
	...
	kiralandigiTarih: z.date({ required_error: "Kiralama tarihi zorunludur." }),
