...
import {Download, Filter, MoreHorizontal, RefreshCw, Search,} from "lucide-react";
import {useState} from "react";
import {Badge} from "@/components/ui/badge";
import {Table, TableBody, TableCell, TableHead, TableHeader, TableRow,} from "@/components/ui/table";
import MarkaDialog from "@/components/web/marka/marka-dialog";
import {markalarGetQueryOptions, useMarkalarQuery,} from "@/hooks/use-firma-hooks.ts";
...
function RouteComponent() {
    ...
    const handleSelectAll = (checked: boolean) => {
        if (checked) {
            setSelectedItems(markalar.map((item: Firma) => item.id));
        } else {
            setSelectedItems([]);
        }
    };
    ...
    const openDialog = (type: keyof DialogState, marka?: Firma) => {
        setDialogState({
            create: type === "create",
            update: type === "update",
            delete: type === "delete",
