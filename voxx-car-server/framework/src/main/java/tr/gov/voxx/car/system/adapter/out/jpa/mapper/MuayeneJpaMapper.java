...
public class MuayeneJpaMapper {
    ...
    public static Muayene toMuayeneFromMuayeneCreatedEvent(MuayeneCreatedEvent muayeneCreatedEvent) {
        return Muayene.builder()
                .id(muayeneCreatedEvent.getId())
                .aracFiloId(muayeneCreatedEvent.getAracFiloId())
                .muayeneTipi(muayeneCreatedEvent.getMuayeneTipi())
                .makbuzNo(muayeneCreatedEvent.getMakbuzNo())
                .odeyenFirmaId(muayeneCreatedEvent.getOdeyenFirmaId())
                .gecikmeCezasi(muayeneCreatedEvent.getGecikmeCezasi())
                .not(muayeneCreatedEvent.getNot())
                .yeri(muayeneCreatedEvent.getYeri())
                .odemeTipi(muayeneCreatedEvent.getOdemeTipi())
                .miktar(muayeneCreatedEvent.getMiktar())
                .odendi(muayeneCreatedEvent.getOdendi())
                .baslangicTarihi(muayeneCreatedEvent.getBaslangicTarihi())
                .bitisTarihi(muayeneCreatedEvent.getBitisTarihi())
                .build();
    }

    public static Muayene toMuayeneFromMuayeneUpdatedEvent(MuayeneUpdatedEvent muayeneUpdatedEvent) {
        return Muayene.builder()
                .id(muayeneUpdatedEvent.getId())
                .aracFiloId(muayeneUpdatedEvent.getAracFiloId())
                .muayeneTipi(muayeneUpdatedEvent.getMuayeneTipi())
                .makbuzNo(muayeneUpdatedEvent.getMakbuzNo())
                .odeyenFirmaId(muayeneUpdatedEvent.getOdeyenFirmaId())
                .gecikmeCezasi(muayeneUpdatedEvent.getGecikmeCezasi())
                .not(muayeneUpdatedEvent.getNot())
                .yeri(muayeneUpdatedEvent.getYeri())
                .odemeTipi(muayeneUpdatedEvent.getOdemeTipi())
                .miktar(muayeneUpdatedEvent.getMiktar())
                .odendi(muayeneUpdatedEvent.getOdendi())
                .baslangicTarihi(muayeneUpdatedEvent.getBaslangicTarihi())
                .bitisTarihi(muayeneUpdatedEvent.getBitisTarihi())
                .build();
    }
}
