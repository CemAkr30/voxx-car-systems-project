...
import tr.gov.voxx.car.system.adapter.out.websocket.BakimWebSocketNotifier;
...
public class BakimEventConsumer {
    ...
    private final BakimWebSocketNotifier bakimWebSocketNotifier;
    ...
    public void consumeCreated(BakimCreatedEvent event) {
        ...
        bakimWebSocketNotifier.notifyBakimCreated(event);
    }
    ...
    public void consumeUpdated(BakimUpdatedEvent event) {
        ...
        bakimWebSocketNotifier.notifyBakimUpdated(event);
    }
